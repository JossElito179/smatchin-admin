...
INSERT INTO
    positions (id_positions, name, acronym)
VALUES
    (1, 'Joueur', 'JR'),
    (2, 'Staff', 'SF'),
    (3, 'Coach', 'CH');
...
VALUES
    (
        ...
        true,
        '1',
        '$2b$10$.7OvJx8g3sBKHQ.VvcLoCetN9RLccvEDe2dNfXGfTOG5B5RbxJ.1u',
        NULL,
        'jhon.cena@club.com'
    ),
    (
...
INSERT INTO
    teams (id_teams, name, logo, is_male, id_users)
VALUES
    (1, 'Les Aigles', NULL, true, 2),
    (2, 'Les Lions', NULL, true, 3),
    (3, 'Les Sharks', NULL, true, 1),
    (4, 'Les Titans', NULL, true, 2),
    (5, 'Les Warriors', NULL, true, 2),
    (6, 'Les Celtics', NULL, false, 2),
    (7, 'Les Lakers', NULL, true, 3),
    (8, 'Les Bulls', NULL, true, 1),
